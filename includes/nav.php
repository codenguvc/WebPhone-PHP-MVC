...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="./">
            <h5 style="color: #2079e7; font-weight: bold; margin-bottom: 0;">
                Phone store
            </h5>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <?php foreach ($categories as $category) : ?>
                            <li><a class="dropdown-item" href="index.php?page=product-cate&id-cate=<?= $category['id_cate'] ?>"><?= $category['name_cate'] ?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </li>
            ...
            <?php if (isset($_SESSION['user'])) { ?>
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-solid fa-user"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
